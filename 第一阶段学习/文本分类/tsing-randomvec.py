...
def mapping(label):
    ...
    label_mapping = label_vocab[label]
...
def encode(sentence, seq_len=20):
    ...
    wordIdx = [vocab.get(word, "[UNK]") for word in sentence]
    return wordIdx
...
class Tsing(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        return torch.tensor(sentence_emb, dtype=torch.float32), label_emb
...
if __name__ == "__main__":
    ...
    validloader = DataLoader(trainset, batch_size = 4, shuffle=False)
